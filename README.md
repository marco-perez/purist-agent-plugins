...
This directory is a self-contained marketplace root. Preserve hidden directories when copying or archiving it. It can be reviewed locally or published later as its own vendor-owned repository. Do not publish the application repository just to distribute this directory.
